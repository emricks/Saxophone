...
deps:
	...
	pip install circuitpython-stubs adafruit-circuitpython-ili9341 adafruit-circuitpython-mcp230xx adafruit-circuitpython-display-text circup
	@echo "Dependencies installed! (Make sure PyCharm's virtual environment is active)"

setup-device: deps
	@echo "Installing libraries to device"
	circup install asyncio adafruit_display_text adafruit_ili9341 adafruit_mcp230xx